...
/****** Object:  Database [ApartmentManagement]    Script Date: 8/15/2022 8:51:41 AM ******/
CREATE DATABASE [ApartmentManagement]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ApartmentManagement', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\ApartmentManagement.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ApartmentManagement_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\ApartmentManagement_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [ApartmentManagement] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [ApartmentManagement] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [ApartmentManagement] SET READ_COMMITTED_SNAPSHOT ON 
GO
...
ALTER DATABASE [ApartmentManagement] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [ApartmentManagement] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [ApartmentManagement] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [ApartmentManagement] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [ApartmentManagement] SET QUERY_STORE = OFF
GO
